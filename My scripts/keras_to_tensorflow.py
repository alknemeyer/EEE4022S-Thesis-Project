...
# usage:
#   python3 keras_to_tensorflow.py -input_model_file
#           model.h5 -output_model_file model.pb

#   python keras_to_tensorflow.py
#       -input_model_file 3_mnist_keras.h5
#       -graph_def True

#   python keras_to_tensorflow.py -input_model_file 3_mnist_keras.h5 -graph_def True
...
parser.add_argument('-output_graphdef_file', action="store",
                    dest='output_graphdef_file', type=str,
                    default='model.ascii')
...
# num_output: this value has nothing to do with the number of classes,
# batch_size, etc., and it is mostly equal to 1.
...
if args.graph_def:
    ...
    tf.train.write_graph(sess.graph.as_graph_def(), output_fld, f,
                         as_text=True)
...
graph_io.write_graph(constant_graph, output_fld, args.output_model_file,
                     as_text=False)
